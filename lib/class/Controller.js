...
class Controller {
  ...
  attachApp( path ){
    return store.get( this ).app.attachApp( path )
  }

  addApp( url ){
    return store.get( this ).app.addApp( url )
  }

  removeApp( name ){
    return store.get( this ).app.removeApp( name )
  }

  getAppPath( name ){
    return store.get( this ).app.getAppPath( name )
  }

  getAllApps(){
    return store.get( this ).app.getAllApps()
  }
